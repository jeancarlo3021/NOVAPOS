...
import {
  ...
  ChevronDown,
  BadgeInfo,
  Inbox, Layers, Send, UserCheck, Undo2, Calculator, Building2, Smartphone, QrCode, Store, CalendarDays, CalendarPlus, ShieldCheck, TrendingUp, MonitorPlay, Crosshair, Users2, Bookmark } from 'lucide-react';
...
const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { name: 'Rastreo',        to: '/distribution/tracking-settings', icon: Navigation, feature: 'tracking' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Portal del contador', to: '/accountant',       icon: Calculator, feature: 'accountant_portal', module: 'reports' },
      { name: 'Negocios',           to: '/businesses',        icon: Building2,  feature: 'businesses_panel', module: 'reports' },
