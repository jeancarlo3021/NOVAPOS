...
import { X, Loader2, ShoppingCart, Info, CheckCircle2, Plus, Ban, AlertTriangle } from 'lucide-react';
          ...
          <>
                  ...
                  {rows.map((r, i) => (
                    <tr key={i} className="border-b border-gray-50">
                      <td className="py-2 pr-2">
                        ...
                        {r.exists && <div className="text-[11px] text-emerald-600">↳ {r.product_name}</div>}
                      </td>
            ...
            <div className="px-5 py-4 border-t border-gray-100 shrink-0">
              ...
              <div className="flex items-center gap-3">
                <div className="text-sm text-gray-500 mr-auto">Total a registrar: <b className="text-gray-900">{fmt(total)}</b></div>
                ...
                <button onClick={accept} disabled={saving}
                  ...
                  {saving ? <><Loader2 size={15} className="animate-spin" /> Procesando…</> : <>Aceptar y agregar a compras</>}
                </button>
              </div>
            </div>
          </>
