...
import { DisplayTestPanel } from './DisplayTestPanel';
  ...
  return (
    <>
      <div className="flex items-center gap-1">
        ...
        {/* Botón de pruebas — siempre disponible */}
        <button
          ...
          title="Probar LCD (configuración y pruebas)"
          type="button"
        >
          <Settings2 size={15} />
        </button>
      ...
      {showTestPanel && (
        <DisplayTestPanel onClose={() => setShowTestPanel(false)} />
      )}
    </>
  );
};
